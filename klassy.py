...
#self.a = a
#self.b = b
#self.hypotenuse = math.sqrt(a**2 + b**2)  # Вычисляем гипотенузу при создании объекта
...
#
# def get_info(self):
# return f"{self.last_name} {self.first_name} {self.middle_name}, Дата рождения: {self.birth_day}.{self.birth_month}.{self.birth_year}, Пол: {self.gender}"
#
# def __del__(self):
# print(f"Объект {self.get_info()} удален")
#
